        ...
        ?>
            ...
            <div class="gauge">
                <div class="progress-bar">
                    <div class="progress" style="width: 10%; background-color: #f44336;"></div>
                </div>
                <h4>Progression : 10%</h4>
            </div>

            <ul class="links">
                <li><a href="https://www.slate.fr/dossier/20613/sensibilisation" class="button">Article</a></li>
                <li><a href="https://www.youtube.com/watch?v=SzG5g0HzVMs" class="button">Vidéo</a></li>
                <li><a href="https://www.quizz.biz/quizz-1198563.html" class="button">Quizz</a></li>
            </ul>
